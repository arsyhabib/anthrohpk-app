...
✅ NEW: "Perpustakaan Ibu Balita" - 50 curated Indonesian articles
...
APP_VERSION = "3.1.0-UPDATED" # MODIFIED from v3.1
...
# ═══════════════════════════════════════════════════════════════════════════════
# SECTION 2B: NEW - YOUTUBE VIDEO LIBRARY & EDUCATIONAL CONTENT (from v3.1)
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# SECTION 2C: NEW - PERPUSTAKAAN IBU BALITA (50 CURATED ARTICLES) (from v3.1)
# ═══════════════════════════════════════════════════════════════════════════════

PERPUSTAKAAN_IBU_BALITA = [
    # CATEGORY: ASI & Menyusui
    {
        "id": 1,
        "title": "🤱 ASI Eksklusif 6 Bulan: Panduan Lengkap untuk Ibu",
        "category": "ASI & Menyusui",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/asi-eksklusif",
        "summary": "Panduan resmi Kemenkes tentang ASI eksklusif selama 6 bulan pertama kehidupan bayi. Menjelaskan manfaat ASI untuk bayi dan ibu, teknik menyusui yang benar, cara menyimpan ASI perah (ASIP), mengatasi masalah menyusui, dan dukungan lingkungan untuk ibu menyusui.",
        "tags": ["ASI", "0-6 bulan", "Menyusui"],
        "reading_time": "8 menit"
    },
    {
        "id": 2,
        "title": "💪 Meningkatkan Produksi ASI Secara Alami",
        "category": "ASI & Menyusui",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/asi/meningkatkan-produksi-asi",
        "summary": "Artikel dari IDAI tentang cara alami meningkatkan produksi ASI. Membahas pentingnya menyusui on-demand, asupan nutrisi ibu, hidrasi yang cukup, manajemen stres, istirahat yang adequate, dan kapan perlu konsultasi dengan konselor laktasi profesional.",
        "tags": ["ASI", "Produksi ASI", "Laktasi"],
        "reading_time": "7 menit"
    },
    {
        "id": 3,
        "title": "🍼 ASI Perah (ASIP): Cara Memerah, Menyimpan & Memberikan",
        "category": "ASI & Menyusui",
        "source": "Kementerian Kesehatan RI",
        "url": "https://www.kemkes.go.id/asi-perah",
        "summary": "Panduan lengkap tentang ASI Perah untuk ibu bekerja atau situasi khusus. Meliputi teknik memerah ASI manual dan dengan pompa, cara sterilisasi alat, aturan penyimpanan ASIP di kulkas dan freezer, cara mencairkan dan menghangatkan ASIP dengan aman, serta tips sukses ASIP.",
        "tags": ["ASIP", "Ibu Bekerja", "Penyimpanan ASI"],
    ...
    {
        "id": 4,
        "title": "🥕 Panduan MPASI WHO: Tepat Waktu, Adekuat, Aman",
        "category": "MPASI",
        "source": "Kementerian Kesehatan RI",
        "url": "https://yankes.kemkes.go.id/view_artikel/3121/",
        "summary": "Petunjuk teknis resmi Kemenkes tentang pemberian MPASI berdasarkan standar WHO 2023. Menjelaskan 4 syarat MPASI yang benar: tepat waktu (6 bulan), adekuat (cukup gizi), aman (higienis), dan cara pemberian yang tepat (responsive feeding). Termasuk panduan porsi dan frekuensi makan per usia.",
        "tags": ["MPASI", "WHO", "6 bulan"],
        "reading_time": "12 menit"
    },
    {
        "id": 5,
        "title": "🍖 Pentingnya Protein Hewani dalam MPASI untuk Cegah Stunting",
        "category": "MPASI",
        "source": "Kementerian Kesehatan RI",
        "url": "https://ayosehat.kemkes.go.id/resep-mpasi-lengkap",
        "summary": "Artikel khusus tentang pentingnya protein hewani (telur, daging, ikan, ayam) dalam MPASI untuk mencegah stunting. Menjelaskan kandungan zat besi, zinc, vitamin A, dan asam amino esensial yang tidak bisa digantikan protein nabati. Lengkap dengan rekomendasi porsi harian protein hewani per usia bayi.",
        "tags": ["Protein Hewani", "Stunting", "MPASI"],
        "reading_time": "9 menit"
    },
    {
        "id": 6,
        "title": "📖 Buku Resep Makanan Lokal Kaya Protein Hewani",
        "category": "MPASI",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/buku-resep-mpasi",
        "summary": "Buku resep resmi Kemenkes berisi 100+ resep MPASI menggunakan bahan lokal Indonesia yang kaya protein hewani. Setiap resep dilengkapi takaran, cara memasak, kandungan gizi, dan disesuaikan dengan usia bayi 6-24 bulan. Tersedia format PDF yang bisa diunduh gratis.",
        "tags": ["Resep MPASI", "Protein", "Buku Panduan"],
        "reading_time": "E-book (Unduh)"
    },
    {
        "id": 7,
        "title": "🥄 Responsive Feeding: Cara Memberi Makan Bayi yang Benar",
        "category": "MPASI",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/pengasuhan-anak/memberi-makan-pada-bayi-kapan-apa-dan-bagaimana",
        "summary": "Penjelasan tentang responsive feeding atau pemberian makan responsif - metode yang direkomendasikan IDAI dan WHO. Membahas cara mengenali sinyal lapar dan kenyang bayi, menciptakan lingkungan makan yang positif, tidak memaksa, dan membangun kebiasaan makan sehat sejak dini.",
        "tags": ["Responsive Feeding", "Pola Makan", "IDAI"],
        "reading_time": "8 menit"
    },
    {
        "id": 8,
        "title": "🍚 Tekstur MPASI: Dari Puree hingga Makanan Keluarga",
        "category": "MPASI",
        "source": "Nutriclub by Nutricia",
        "url": "https://www.nutriclub.co.id/artikel/nutrisi/4-6-bulan/makanan-bayi-6-bulan",
        "summary": "Panduan lengkap tentang tahapan tekstur MPASI sesuai usia bayi. Mulai dari puree halus (6 bulan), mashed/lumat (7-8 bulan), minced/cincang halus (9-11 bulan), hingga makanan keluarga (12+ bulan). Dilengkapi tips transisi tekstur dan tanda bayi siap naik tekstur.",
        "tags": ["Tekstur MPASI", "Tahapan", "Usia"],
        "reading_time": "7 menit"
    },
    {
        "id": 9,
        "title": "🥗 Menu 4 Bintang vs Menu Lengkap MPASI: Mana yang Benar?",
        "category": "MPASI",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/asi/menu-mpasi",
        "summary": "Klarifikasi dari IDAI tentang konsep 'menu 4 bintang' yang populer versus rekomendasi terbaru WHO 2023. Menjelaskan bahwa yang terpenting adalah MPASI mengandung makronutrien (karbohidrat, protein, lemak) dan mikronutrien (zat besi, zinc, vitamin A) yang cukup, bukan jumlah bintangnya.",
        "tags": ["Menu MPASI", "4 Bintang", "WHO 2023"],
        "reading_time": "6 menit"
    },
    
    # CATEGORY: Stunting & Gizi Buruk
    {
        "id": 10,
        "title": "📏 Stunting: Pengertian, Penyebab, dan Cara Mencegahnya",
        "category": "Stunting",
        "source": "Kementerian Kesehatan RI",
        "url": "https://yankes.kemkes.go.id/view_artikel/1388/",
        "summary": "Artikel komprehensif Kemenkes tentang stunting - kondisi gagal tumbuh pada anak akibat kekurangan gizi kronis. Menjelaskan definisi stunting (tinggi badan <-2 SD kurva WHO), penyebab, dampak jangka panjang terhadap kognitif dan kesehatan, serta strategi pencegahan melalui 1000 Hari Pertama Kehidupan (HPK).",
        "tags": ["Stunting", "Gizi", "Pencegahan"],
        "reading_time": "10 menit"
    },
    {
        "id": 11,
        "title": "🎯 Intervensi Gizi Spesifik dan Sensitif Cegah Stunting",
        "category": "Stunting",
        "source": "Kementerian Kesehatan RI",
        "url": "https://kemkes.go.id/id/kejar-target-stunting-turun-hingga-14-kemenkes-lakukan-pendekatan-gizi-spesifik",
        "summary": "Penjelasan tentang 2 pendekatan pencegahan stunting: (1) Intervensi Gizi Spesifik - tablet tambah darah, ASI eksklusif, MPASI kaya protein hewani, imunisasi; (2) Intervensi Gizi Sensitif - air bersih, sanitasi, pola asuh, Program Keluarga Harapan (PKH). Lengkap dengan timeline intervensi dari remaja hingga balita.",
        "tags": ["Stunting", "Intervensi", "Program"],
        "reading_time": "11 menit"
    },
    {
        "id": 12,
        "title": "🏥 Deteksi Dini dan Pemantauan Pertumbuhan Anak di Posyandu",
        "category": "Stunting",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/pemantauan-pertumbuhan",
        "summary": "Pentingnya rutin ke Posyandu untuk pemantauan pertumbuhan anak. Menjelaskan cara pengukuran antropometri (berat, tinggi, lingkar kepala), interpretasi kurva pertumbuhan, tanda-tanda gangguan pertumbuhan yang perlu diwaspadai, dan kapan harus rujuk ke dokter anak atau puskesmas.",
        "tags": ["Posyandu", "Pemantauan", "Deteksi Dini"],
        "reading_time": "8 menit"
    },
    {
        "id": 13,
        "title": "🍽️ Isi Piringku untuk Balita: Panduan Gizi Seimbang",
        "category": "Stunting",
        "source": "Kementerian Kesehatan RI",
        "url": "https://sehatnegeriku.kemkes.go.id/baca/rilis-media/20180407/1825480/",
        "summary": "Konsep 'Isi Piringku' dari Kemenkes untuk panduan gizi seimbang balita. Komposisi ideal dalam satu porsi makan: 50% sayur dan buah, 50% sisanya terbagi untuk protein (lebih banyak) dan karbohidrat. Dilengkapi contoh menu sehari-hari dan tips praktis untuk keluarga Indonesia.",
        "tags": ["Gizi Seimbang", "Isi Piringku", "Menu"],
        "reading_time": "9 menit"
    },
    ...
    # CATEGORY: Perkembangan Anak
    {
        ...
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/seputar-kesehatan-anak/milestone-perkembangan",
        "summary": "Daftar lengkap milestone (tonggak perkembangan) anak dari lahir hingga 5 tahun. Mencakup 4 aspek: motorik kasar, motorik halus, bahasa/bicara, dan sosial-emosional. Menjelaskan variasi normal, red flags yang perlu diwaspadai, dan kapan harus konsultasi ke dokter anak.",
        "tags": ["Milestone", "Perkembangan", "0-5 tahun"],
        "reading_time": "15 menit"
    },
    {
        "id": 15,
        "title": "🎯 KPSP (Kuesioner Pra Skrining Perkembangan): Panduan Lengkap",
        "category": "Perkembangan",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/kpsp-deteksi-dini",
        "summary": "Panduan lengkap tentang KPSP - alat deteksi dini perkembangan anak yang bisa dilakukan orang tua di rumah. Berisi formulir KPSP untuk setiap usia (3, 6, 9, 12, 15, 18, 21, 24 bulan), cara pengisian, interpretasi hasil (sesuai/meragukan/menyimpang), dan tindak lanjut yang perlu dilakukan.",
        "tags": ["KPSP", "Skrining", "Deteksi Dini"],
        "reading_time": "12 menit"
    },
    {
        "id": 16,
        "title": "🗣️ Stimulasi Bahasa Anak Sejak Dini",
        "category": "Perkembangan",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/pengasuhan-anak/stimulasi-bahasa",
        "summary": "Panduan stimulasi bahasa anak dari IDAI. Menjelaskan tahapan perkembangan bahasa normal, cara stimulasi efektif di setiap usia (membacakan buku, bernyanyi, berbicara 2 arah), mengenali keterlambatan bicara, kapan perlu terapi wicara, dan pentingnya interaksi langsung (bukan screen time).",
        "tags": ["Bahasa", "Stimulasi", "Keterlambatan Bicara"],
        "reading_time": "10 menit"
    },
    {
        "id": 17,
        "title": "🤸 Stimulasi Motorik Kasar dan Halus Sesuai Usia",
        "category": "Perkembangan",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/stimulasi-motorik",
        "summary": "Panduan stimulasi perkembangan motorik anak. Memberikan ide aktivitas konkret untuk setiap usia: tummy time (0-3 bulan), meraih mainan (4-6 bulan), merangkak (7-9 bulan), berjalan (10-12 bulan), naik tangga, melompat, hingga keterampilan motorik halus seperti memegang pensil dan menggunting.",
        "tags": ["Motorik", "Stimulasi", "Aktivitas"],
        "reading_time": "11 menit"
    },
    {
        "id": 18,
        "title": "❤️ Perkembangan Sosial-Emosional dan Bonding dengan Anak",
        "category": "Perkembangan",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/pengasuhan-anak/perkembangan-sosial-emosional",
        "summary": "Pentingnya perkembangan sosial-emosional yang sehat sejak bayi. Membahas attachment (kelekatan) dengan orang tua, mengenali dan mengelola emosi, bermain dengan teman sebaya, empati, dan kemandirian. Dilengkapi tips praktis membangun bonding yang kuat dengan anak di tengah kesibukan orang tua modern.",
        "tags": ["Sosial-Emosional", "Bonding", "Kelekatan"],
        "reading_time": "9 menit"
    },
    ...
    {
        "id": 19,
        "title": "💉 Jadwal Imunisasi Anak Lengkap (IDAI 2023)",
        "category": "Imunisasi",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/imunisasi/jadwal-imunisasi-anak",
        "summary": "Jadwal imunisasi terbaru dari IDAI tahun 2023, lebih lengkap dari jadwal Kemenkes. Meliputi imunisasi wajib (program pemerintah) dan imunisasi tambahan yang direkomendasikan. Lengkap dengan usia pemberian, jenis vaksin, interval booster, dan penjelasan penyakit yang dicegah oleh setiap vaksin.",
        "tags": ["Imunisasi", "Vaksin", "Jadwal"],
        "reading_time": "13 menit"
    },
    {
        "id": 20,
        "title": "🛡️ Pentingnya Imunisasi Dasar Lengkap untuk Anak",
        "category": "Imunisasi",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/imunisasi-dasar-lengkap",
        "summary": "Penjelasan tentang pentingnya imunisasi dasar lengkap untuk melindungi anak dari penyakit berbahaya (difteri, tetanus, pertusis, hepatitis B, polio, campak, rubella, pneumonia, meningitis). Membantah mitos-mitos seputar imunisasi dengan bukti ilmiah, keamanan vaksin, dan efek samping ringan yang normal.",
        "tags": ["Imunisasi", "Vaksin", "Perlindungan"],
        "reading_time": "10 menit"
    },
    {
        "id": 21,
        "title": "📋 Program Imunisasi Nasional dan Vaksin Gratis",
        "category": "Imunisasi",
        "source": "Kementerian Kesehatan RI",
        "url": "https://kemkes.go.id/id/program-imunisasi-nasional",
        "summary": "Informasi tentang Program Imunisasi Nasional (PIN) Indonesia. Vaksin-vaksin yang tersedia gratis di Puskesmas dan Posyandu, cara mengakses program imunisasi gratis, dokumen yang diperlukan, dan apa yang harus dilakukan jika anak terlambat atau belum lengkap imunisasinya (catch-up immunization).",
        "tags": ["Program Imunisasi", "Gratis", "Puskesmas"],
        "reading_time": "8 menit"
    },
    
    # CATEGORY: Penyakit Umum Anak
    {
        "id": 22,
        "title": "🤒 Demam pada Anak: Kapan Harus ke Dokter?",
        "category": "Penyakit Umum",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/keluhan-anak/demam-pada-anak",
        "summary": "Panduan lengkap tentang demam pada anak dari IDAI. Menjelaskan definisi demam (>37.5°C), cara mengukur suhu yang benar, kapan demam berbahaya (red flags: bayi <3 bulan, demam >40°C, kejang, sesak napas, ruam, sangat lemas), pertolongan pertama di rumah, dan kapan harus segera ke dokter/UGD.",
        "tags": ["Demam", "Penyakit", "Emergency"],
        "reading_time": "9 menit"
    },
    {
        "id": 23,
        "title": "💦 Diare pada Bayi dan Balita: Pencegahan & Penanganan",
        "category": "Penyakit Umum",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/diare-anak",
        "summary": "Artikel Kemenkes tentang diare - penyebab utama kematian balita di Indonesia. Membahas penyebab (infeksi, alergi makanan, intoleransi laktosa), cara mencegah (ASI eksklusif, MPASI higienis, cuci tangan, sanitasi), tanda dehidrasi, cara membuat dan memberikan oralit/cairan rehidrasi oral (CRO), dan kapan perlu rawat inap.",
        "tags": ["Diare", "Dehidrasi", "Oralit"],
        "reading_time": "11 menit"
    },
    {
        "id": 24,
        "title": "😷 ISPA (Infeksi Saluran Pernapasan Akut) pada Anak",
        "category": "Penyakit Umum",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/keluhan-anak/ispa",
        "summary": "Panduan tentang ISPA - penyakit infeksi yang paling sering menyerang anak. Membedakan ISPA atas (flu, batuk pilek) dan ISPA bawah (bronkiolitis, pneumonia). Menjelaskan gejala, kapan harus waspada (sesak napas, nafas cepat, tarikan dinding dada), pengobatan di rumah, dan pentingnya imunisasi PCV dan Hib untuk pencegahan.",
        "tags": ["ISPA", "Batuk", "Sesak Napas"],
        "reading_time": "10 menit"
    },
    {
        "id": 25,
        "title": "🤢 Muntah pada Anak: Penyebab dan Penanganan",
        "category": "Penyakit Umum",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/keluhan-anak/muntah",
        "summary": "Artikel IDAI tentang muntah pada anak - membedakan muntah fisiologis (gumoh normal pada bayi) dan patologis yang perlu penanganan. Menjelaskan penyebab (gastroenteritis, alergi makanan, keracunan, obstruksi), bahaya aspirasi, cara mencegah dehidrasi, posisi yang aman, dan red flags yang mengharuskan segera ke dokter.",
        "tags": ["Muntah", "Gumoh", "Dehidrasi"],
        "reading_time": "8 menit"
    },
    ...
    {
        "id": 26,
        "title": "🤰 Gizi Ibu Hamil untuk Cegah Stunting Sejak dalam Kandungan",
        "category": "Kesehatan Ibu",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/gizi-ibu-hamil",
        "summary": "Panduan gizi ibu hamil dari Kemenkes untuk mencegah stunting sejak dalam kandungan. Menjelaskan kebutuhan makronutrien dan mikronutrien (asam folat, zat besi, kalsium, DHA), pentingnya tablet tambah darah (TTD) minimal 90 tablet selama kehamilan, mengatasi mual-muntah, dan monitoring berat badan ibu hamil.",
        "tags": ["Ibu Hamil", "Gizi", "TTD"],
        "reading_time": "12 menit"
    },
    {
        "id": 27,
        "title": "🩺 Pemeriksaan Kehamilan (ANC) yang Berkualitas",
        "category": "Kesehatan Ibu",
        "source": "Kementerian Kesehatan RI",
        "url": "https://kemkes.go.id/id/antenatal-care",
        "summary": "Standar pemeriksaan kehamilan (ANC) berkualitas menurut Kemenkes: minimal 6 kali selama kehamilan (2x dengan dokter termasuk USG). Menjelaskan apa saja yang diperiksa di setiap kunjungan, deteksi dini komplikasi kehamilan (preeklampsia, diabetes gestasional, anemia), dan pentingnya buku KIA (Kesehatan Ibu dan Anak).",
        "tags": ["ANC", "Kehamilan", "Pemeriksaan"],
        "reading_time": "10 menit"
    },
    {
        "id": 28,
        "title": "💊 Suplemen untuk Ibu Hamil dan Menyusui",
        "category": "Kesehatan Ibu",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/ibu/suplemen-ibu-hamil",
        "summary": "Panduan IDAI tentang suplemen yang dibutuhkan ibu hamil dan menyusui. Meliputi asam folat (400-800 mcg/hari), zat besi (tablet tambah darah), kalsium (1000-1300 mg/hari), vitamin D, DHA/omega-3, dan multivitamin prenatal. Menjelaskan manfaat, dosis, kapan mulai konsumsi, dan interaksi dengan makanan.",
        "tags": ["Suplemen", "Ibu Hamil", "Vitamin"],
        "reading_time": "9 menit"
    },
    {
        "id": 29,
        "title": "😌 Kesehatan Mental Ibu: Mencegah Depresi Postpartum",
        "category": "Kesehatan Ibu",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/kesehatan-mental-ibu",
        "summary": "Pentingnya kesehatan mental ibu hamil dan setelah melahirkan. Menjelaskan baby blues (normal, 2 minggu pertama) vs depresi postpartum (perlu penanganan). Tanda-tanda depresi postpartum, faktor risiko, dampak pada ibu dan bayi, cara mencegah (dukungan keluarga, istirahat cukup, support group), dan kapan harus konsultasi psikolog/psikiater.",
        "tags": ["Kesehatan Mental", "Postpartum", "Ibu"],
        "reading_time": "11 menit"
    },
    ...
    {
        "id": 30,
        "title": "👨‍👩‍👧 Pola Asuh Positif untuk Tumbuh Kembang Optimal",
        "category": "Pola Asuh",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/pola-asuh-positif",
        "summary": "Panduan pola asuh positif (positive parenting) dari Kemenkes. Menjelaskan prinsip-prinsip dasar: responsif terhadap kebutuhan anak, konsisten tapi fleksibel, disiplin positif tanpa kekerasan, komunikasi 2 arah, quality time, dan melibatkan ayah. Dilengkapi contoh praktis untuk berbagai situasi sehari-hari.",
        "tags": ["Pola Asuh", "Parenting", "Disiplin Positif"],
        "reading_time": "13 menit"
    },
    {
        "id": 31,
        "title": "📱 Dampak Screen Time Berlebihan pada Anak",
        "category": "Pola Asuh",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/seputar-kesehatan-anak/screen-time",
        "summary": "Rekomendasi IDAI tentang batasan screen time untuk anak: 0 screen time untuk <18 bulan, maksimal 1 jam/hari untuk 2-5 tahun dengan konten berkualitas dan didampingi. Menjelaskan dampak negatif screen time berlebihan (keterlambatan bahasa, obesitas, gangguan tidur, ADHD), dan alternatif aktivitas yang lebih baik.",
        "tags": ["Screen Time", "Gadget", "Dampak"],
        "reading_time": "10 menit"
    },
    {
        "id": 32,
        "title": "🎭 Mendisiplinkan Anak Tanpa Kekerasan",
        "category": "Pola Asuh",
        "source": "Kementerian Pemberdayaan Perempuan dan Perlindungan Anak (KPPPA)",
        "url": "https://www.kemenpppa.go.id/disiplin-tanpa-kekerasan",
        "summary": "Panduan dari KPPPA tentang disiplin positif tanpa kekerasan fisik maupun verbal. Menjelaskan dampak negatif hukuman fisik dan yelling pada perkembangan anak, strategi disiplin efektif (time-in, natural consequences, positive reinforcement), mengelola emosi orang tua, dan menciptakan aturan yang konsisten.",
        "tags": ["Disiplin", "Kekerasan", "KPPPA"],
        "reading_time": "11 menit"
    },
    {
        "id": 33,
        "title": "📚 Membacakan Buku untuk Anak Sejak Bayi",
        "category": "Pola Asuh",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/pengasuhan-anak/membacakan-buku",
        "summary": "Manfaat membacakan buku untuk anak sejak bayi dari IDAI. Meningkatkan bonding, stimulasi bahasa, imajinasi, konsentrasi, dan minat baca kelak. Tips memilih buku sesuai usia (board book untuk bayi, picture book untuk balita), cara membacakan yang menarik (gunakan intonasi, ajukan pertanyaan), dan menjadikannya rutinitas sebelum tidur.",
        "tags": ["Membaca", "Literasi", "Bonding"],
        "reading_time": "8 menit"
    },
    ...
    {
        "id": 34,
        "title": "🧼 Cuci Tangan Pakai Sabun: Pencegahan Penyakit Sederhana",
        "category": "Kebersihan",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/cuci-tangan-pakai-sabun",
        "summary": "Kampanye Kemenkes tentang pentingnya Cuci Tangan Pakai Sabun (CTPS) untuk mencegah diare, ISPA, cacingan, dan penyakit lainnya. Menjelaskan 5 waktu penting cuci tangan (sebelum makan, setelah BAB, sebelum menyiapkan makanan, setelah mengganti popok, setelah batuk/bersin), 6 langkah cuci tangan yang benar (WHO), dan mengajarkan anak cuci tangan.",
        "tags": ["Cuci Tangan", "CTPS", "Kebersihan"],
        "reading_time": "7 menit"
    },
    {
        "id": 35,
        "title": "🚰 Pentingnya Air Bersih dan Sanitasi untuk Keluarga",
        "category": "Kebersihan",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/sanitasi-air-bersih",
        "summary": "Artikel tentang pentingnya akses air bersih dan sanitasi layak untuk mencegah stunting dan penyakit. Menjelaskan syarat air bersih untuk minum dan memasak, cara pengolahan air sederhana (merebus, klorinasi), pentingnya jamban sehat, dan hubungan sanitasi buruk dengan diare berulang yang menyebabkan stunting pada anak.",
        "tags": ["Sanitasi", "Air Bersih", "Jamban"],
        "reading_time": "9 menit"
    },
    {
        "id": 36,
        "title": "🍽️ Keamanan Pangan di Rumah untuk Keluarga",
        "category": "Kebersihan",
        "source": "BPOM RI",
        "url": "https://www.pom.go.id/keamanan-pangan-rumah",
        "summary": "Panduan keamanan pangan dari BPOM untuk mencegah keracunan makanan dan kontaminasi. Prinsip 5 kunci keamanan pangan WHO: gunakan air dan bahan baku bersih, pisahkan makanan mentah dan matang, masak dengan sempurna, simpan pada suhu aman, dan gunakan air serta bahan baku yang aman. Khusus untuk MPASI dan makanan anak.",
        "tags": ["Keamanan Pangan", "BPOM", "MPASI"],
        "reading_time": "10 menit"
    },
    
    # CATEGORY: Tumbuh Kembang Khusus
    {
        "id": 37,
        "title": "🦷 Kesehatan Gigi dan Mulut Anak Sejak Dini",
        "category": "Tumbuh Kembang",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/keluhan-anak/kesehatan-gigi",
        "summary": "Panduan kesehatan gigi anak dari IDAI. Kapan gigi pertama tumbuh (6-12 bulan), cara merawat gigi susu (sikat gigi 2x sehari dengan pasta ber-fluoride), mencegah karies botol susu (jangan tidur sambil minum susu), makanan yang baik dan buruk untuk gigi, dan kapan pertama kali ke dokter gigi (usia 1 tahun atau saat gigi pertama tumbuh).",
        "tags": ["Gigi", "Karies", "Fluoride"],
        "reading_time": "9 menit"
    },
    {
        "id": 38,
        "title": "😴 Pentingnya Tidur Cukup untuk Tumbuh Kembang Anak",
        "category": "Tumbuh Kembang",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/pengasuhan-anak/tidur-anak",
        "summary": "Artikel IDAI tentang kebutuhan tidur anak per usia: bayi baru lahir (14-17 jam), 4-12 bulan (12-16 jam), 1-2 tahun (11-14 jam), 3-5 tahun (10-13 jam). Menjelaskan manfaat tidur cukup (pertumbuhan fisik, konsolidasi memori, sistem imun), tanda kurang tidur, sleep hygiene yang baik, dan mengatasi masalah tidur (sleep training).",
        "tags": ["Tidur", "Sleep Training", "Istirahat"],
        "reading_time": "10 menit"
    },
    {
        "id": 39,
        "title": "👶 Bayi Prematur: Perawatan dan Pemantauan Khusus",
        "category": "Tumbuh Kembang",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/bayi/bayi-prematur",
        "summary": "Panduan lengkap untuk bayi prematur (<37 minggu) dari IDAI. Menjelaskan komplikasi yang mungkin terjadi, perawatan metode kanguru (PMK), pentingnya ASI untuk bayi prematur, cara menghitung usia koreksi untuk penilaian tumbuh kembang, imunisasi untuk bayi prematur, dan pemantauan jangka panjang yang diperlukan.",
        "tags": ["Prematur", "PMK", "Usia Koreksi"],
        "reading_time": "12 menit"
    },
    {
        "id": 40,
        ...
        "category": "Tumbuh Kembang",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/keluhan-anak/autisme",
        "summary": "Panduan deteksi dini autisme dari IDAI. Red flags autisme: tidak ada kontak mata, tidak respons saat dipanggil nama (usia 12 bulan), keterlambatan bahasa, gerakan berulang (flapping, spinning), kesulitan interaksi sosial, sensitivitas sensorik berlebihan. Menjelaskan M-CHAT (Modified Checklist for Autism in Toddlers) dan pentingnya intervensi dini.",
        "tags": ["Autisme", "Deteksi Dini", "M-CHAT"],
        "reading_time": "11 menit"
    },
    
    # CATEGORY: Alergi & Intoleransi
    {
        "id": 41,
        "title": "🥜 Alergi Makanan pada Anak: Mengenali dan Mengatasi",
        "category": "Alergi",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/keluhan-anak/alergi-makanan",
        "summary": "Panduan komprehensif tentang alergi makanan dari IDAI. Perbedaan alergi dan intoleransi makanan, 8 makanan alergen utama (susu sapi, telur, kacang tanah, seafood, gandum, kedelai, tree nuts, ikan), gejala alergi (ringan hingga anafilaksis), cara melakukan food elimination dan reintroduction, dan kapan perlu tes alergi.",
        "tags": ["Alergi Makanan", "Alergen", "Anafilaksis"],
        "reading_time": "13 menit"
    },
    {
        "id": 42,
        "title": "🥛 Alergi Protein Susu Sapi (APLMS) pada Bayi",
        "category": "Alergi",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/keluhan-anak/alergi-susu-sapi",
        "summary": "Artikel spesifik tentang Alergi Protein Susu Sapi (APLMS) - salah satu alergi makanan tersering pada bayi. Gejala (kolik berlebihan, muntah, diare berdarah, eksim), diagnosis, diet eliminasi protein susu sapi untuk ibu menyusui, susu formula extensively hydrolyzed/amino acid-based, dan kapan biasanya alergi menghilang (sebagian besar usia 3-5 tahun).",
        "tags": ["APLMS", "Alergi Susu", "Kolik"],
        "reading_time": "10 menit"
    },
    {
        "id": 43,
        "title": "🌾 Intoleransi Laktosa vs Alergi Susu: Apa Bedanya?",
        "category": "Alergi",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/keluhan-anak/intoleransi-laktosa",
        "summary": "Klarifikasi perbedaan intoleransi laktosa (defisiensi enzim laktase, gejala pencernaan saja) dan alergi protein susu sapi (respons imun, bisa reaksi berat). Intoleransi laktosa jarang pada bayi (kecuali galaktosemia bawaan), lebih sering pada anak besar dan dewasa. Penanganan berbeda: susu low-lactose untuk intoleransi vs diet eliminasi protein susu untuk alergi.",
        "tags": ["Intoleransi Laktosa", "Laktase", "Alergi"],
        "reading_time": "8 menit"
    },
    ...
    {
        "id": 44,
        "title": "🤱 Relaktasi: Kembali Menyusui Setelah Berhenti",
        "category": "ASI Lanjutan",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/asi/relaktasi",
        "summary": "Panduan relaktasi - proses kembali memproduksi ASI setelah sempat berhenti menyusui. Menjelaskan kapan relaktasi mungkin dilakukan, teknik stimulasi payudara intensif, pentingnya dukungan keluarga, mengelola ekspektasi (produksi ASI mungkin tidak 100% kembali), suplemen galaktagog, dan konsultasi dengan konselor laktasi.",
        "tags": ["Relaktasi", "ASI", "Laktasi"],
        "reading_time": "9 menit"
    },
    {
        "id": 45,
        "title": "👶 Bayi Berat Lahir Rendah (BBLR): Perawatan Khusus",
        "category": "Kondisi Khusus",
        "source": "Kementerian Kesehatan RI",
        "url": "https://promkes.kemkes.go.id/bblr",
        "summary": "Panduan Kemenkes untuk Bayi Berat Lahir Rendah (<2500 gram). Penyebab BBLR (prematuritas, malnutrisi ibu hamil, infeksi), komplikasi (hipotermia, hipoglikemia, gangguan napas), perawatan metode kanguru (PMK) untuk menjaga suhu tubuh, pentingnya ASI, monitoring ketat pertumbuhan, dan pencegahan BBLR pada kehamilan berikutnya.",
        "tags": ["BBLR", "PMK", "Berat Lahir"],
        "reading_time": "11 menit"
    },
    {
        "id": 46,
        "title": "🩺 Anemia pada Anak: Pencegahan dan Pengobatan",
        "category": "Kondisi Khusus",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/keluhan-anak/anemia",
        "summary": "Artikel IDAI tentang anemia defisiensi besi - penyebab anemia tersering pada anak. Gejala (pucat, lemas, sulit konsentrasi, pica), penyebab (kurang asupan zat besi, ASI eksklusif >6 bulan tanpa MPASI, infeksi cacingan), pencegahan (MPASI kaya zat besi hewani), pengobatan (suplemen besi), dan pemeriksaan hemoglobin berkala.",
        "tags": ["Anemia", "Zat Besi", "Hemoglobin"],
        "reading_time": "10 menit"
    },
    {
        "id": 47,
        "title": "🌡️ Kejang Demam pada Anak: Apa yang Harus Dilakukan?",
        "category": "Kondisi Khusus",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/keluhan-anak/kejang-demam",
        "summary": "Panduan lengkap kejang demam dari IDAI. Definisi (kejang saat demam pada anak 6 bulan-5 tahun), jenis (sederhana vs kompleks), pertolongan pertama saat kejang (miringkan tubuh, longgarkan pakaian, jangan masukkan apapun ke mulut, catat durasi), pencegahan (kontrol demam dengan paracetamol/ibuprofen), dan kapan perlu obat anti-kejang profilaksis.",
        "tags": ["Kejang Demam", "Emergency", "Demam"],
        "reading_time": "12 menit"
    },
    
    # CATEGORY: Nutrisi Lanjutan
    {
        "id": 48,
        "title": "🥗 Makanan Sehat untuk Anak Picky Eater (Pemilih Makanan)",
        "category": "Nutrisi",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/pengasuhan-anak/picky-eater",
        "summary": "Strategi dari IDAI untuk mengatasi anak yang pilih-pilih makanan (picky eater). Penyebab (fase normal perkembangan, tekstur/rasa tertentu, trauma makan), cara mengatasi (jangan memaksa, repeated exposure 10-15x, libatkan anak dalam memasak, jadilah role model, sajikan porsi kecil beraneka warna), dan membedakan picky eater normal vs feeding disorder.",
        "tags": ["Picky Eater", "Susah Makan", "Feeding"],
        "reading_time": "11 menit"
    },
    {
        "id": 49,
        "title": "🥤 Pentingnya Hidrasi: Kebutuhan Cairan Anak per Usia",
        "category": "Nutrisi",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/keluhan-anak/hidrasi",
        "summary": "Panduan kebutuhan cairan anak dari IDAI. Kebutuhan per usia: 0-6 bulan (cukup ASI), 6-12 bulan (ASI + air putih sedikit 60-120ml), 1-3 tahun (1300ml/hari), 4-8 tahun (1700ml/hari). Tanda dehidrasi ringan-sedang-berat, cara menghitung kebutuhan cairan saat diare/demam, jenis minuman yang baik (air putih) dan dihindari (juice berlebihan, soft drink).",
        "tags": ["Hidrasi", "Cairan", "Dehidrasi"],
        "reading_time": "8 menit"
    },
    {
        "id": 50,
        "title": "🍬 Bahaya Gula Berlebihan pada Anak dan Batas Amannya",
        "category": "Nutrisi",
        "source": "IDAI (Ikatan Dokter Anak Indonesia)",
        "url": "https://www.idai.or.id/artikel/klinik/pengasuhan-anak/gula-berlebihan",
        "summary": "Peringatan IDAI tentang konsumsi gula berlebihan pada anak. Dampak (obesitas, karies gigi, diabetes tipe 2, penyakit jantung di masa depan, pola makan buruk). Rekomendasi WHO: 0 gula tambahan untuk <2 tahun, maksimal 25 gram (6 sendok teh) untuk >2 tahun. Sumber gula tersembunyi (makanan olahan, minuman kemasan), cara membaca label nutrisi, dan alternatif camilan sehat.",
        "tags": ["Gula", "Obesitas", "Karies"],
        "reading_time": "10 menit"
    }
]
...
print(f"   - {len(PERPUSTAKAAN_IBU_BALITA)} curated articles in Library")
...
print("=" * 80)
print(f"🚀 AnthroHPK v{APP_VERSION} - Configuration Complete")
print("=" * 80)
...
# ═══════════════════════════════════════════════════════════════════════════════
# SECTION 6: GROWTH CURVE GENERATION (from v3.0)
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# SECTION 7: MATPLOTLIB PLOTTING FUNCTIONS (from v3.0)
# ═══════════════════════════════════════════════════════════════════════════════
...
# ═══════════════════════════════════════════════════════════════════════════════
# SECTION 8: EXPORT FUNCTIONS (PDF & CSV) (from v3.0)
# ═══════════════════════════════════════════════════════════════════════════════
...
def generate_qr_code(text: str = None) -> Optional[io.BytesIO]:
    ...
    """
    if text is None:
        text = f"https://wa.me/{CONTACT_WA}?text=Halo%20AnthroHPK,%20saya%20tertarik%20dengan%20aplikasi%20ini"
...
def export_to_csv(payload: Dict, filename: str) -> Optional[str]:
    ...
    try:
        ...
        with open(filepath, 'w', newline='', encoding='utf-8-sig') as f:
            ...
            # Header
            writer.writerow(['═══════════════════════════════════════════════════════════'])
            writer.writerow(['ANTHROHPK - LAPORAN ANALISIS PERTUMBUHAN ANAK'])
...
def export_to_pdf(payload: Dict, figures: List[Figure], filename: str) -> Optional[str]:
    ...
    try:
        ...
        c.drawString(30, H - 30, "AnthroHPK - Laporan Analisis Pertumbuhan Anak")
...
# ═══════════════════════════════════════════════════════════════════════════════
# SECTION 9: ANALYSIS HANDLER & INTERPRETATION (from v3.0)
# ═══════════════════════════════════════════════════════════════════════════════
...
def run_comprehensive_analysis(
    ...
    try:
        ...
        pdf_filename = f"AnthroHPK_{child_safe_name}_{timestamp}.pdf"
        csv_filename = f"AnthroHPK_{child_safe_name}_{timestamp}.csv"
